...
from .MatrixMaps import PLAYHEAD_FEEDBACK_CHANNELS, NON_FEEDBACK_CHANNEL
...
class StepSeqComponent(StepSeqComponent, APCMessenger):
    ...
    def selected_track(self):
        ...
        retVal = 0
        if song.view.selected_track in list(song.tracks):
            retVal = list(song.tracks).index(song.view.selected_track)
