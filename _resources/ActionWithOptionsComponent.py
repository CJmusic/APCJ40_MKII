...
class OptionsComponent(ControlSurfaceComponent):
    ...
    def _set_option_names(self, value):
        ...
        self.select_buttons.control_count = len(list(value))
    ...
    def _set_selected_option(self, selected_option):
        # if not (in_range(selected_option, 0, len(list(self.option_names))) or selected_option is None):
    ...
    def _on_select_value(self, button):
        ...
        if in_range(index, 0, len(list(self.option_names))): #added list 
