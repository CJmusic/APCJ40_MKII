...
SEQ_FEEDBACK_CHANNEL = 13
LOOP_FEEDBACK_CHANNEL = 11
DRUM_FEEDBACK_CHANNEL = 12
NON_FEEDBACK_CHANNEL = 0
PLAYHEAD_FEEDBACK_CHANNEL = 1
PLAYHEAD_FEEDBACK_CHANNELS = list(range(2, 10))
FEEDBACK_CHANNELS = list(range(10,14))
...
# Mappings for USER MODE/NOTE MODE are defined in this file
...
PATTERN_4 = ((5, 5, 5, 5, 5, 5, 5, 5), #Row 1
             (3, 3, 3, 3, 3, 3, 3, 3), #Row 2
             (1, 1, 1, 3, 1, 1, 1, 3), #Row 3
             (5, 5, 1, 3, 5, 5, 1, 3), #Row 4
             (1, 5, 1, 3, 1, 5, 1, 3), #Row 5
             (1, 1, 1, 1, 1, 1, 1, 1), #Clip Stop Row
             ) #0=off, 1=green, 2=green blink, 3=red, 4=red blink, 5=yellow, 6=yellow blink, 7-127=green

CHANNEL_4 = 12

NOTEMAP_4 = ((52, 53, 54, 55, 52, 53, 54, 55), #Row 1
             (48, 49, 50, 51, 48, 49, 50, 51), #Row 2
             (44, 45, 46, 47, 44, 45, 46, 47), #Row 3
             (40, 41, 42, 43, 40, 41, 42, 43), #Row 4
             (36, 37, 38, 39, 36, 37, 38, 39), #Row 5
             (56, 57, 58, 59, 56, 57, 58, 59), #Clip Stop Row
             )
